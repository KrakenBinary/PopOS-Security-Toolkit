#!/usr/bin/env bash
  register_tool "gh" "GitHub CLI" "Development Tools" "gh" "gh" \
      "Official GitHub command line tool. Interact with pull requests, issues, repos, gists, and more directly from the terminal. Supports authentication and git
